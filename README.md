...
make local-build
```
This produces the `demo-native-mc` executable at the repository root.
...
Usage: Valid command-line arguments are:
        ...
        [-n, --number-of-investments <Number of investments in portfolio: size_t in [1, inf)> (Default: 150)]
